...
Rails.application.configure do
  ...
  # Do not allow on-the-fly asset compilation in production; precompile assets locally or in CI
  config.assets.compile = false

  # Rails can serve static files if RAILS_SERVE_STATIC_FILES is set (Heroku sets this automatically when using the Ruby buildpack)
