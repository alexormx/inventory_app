class AddApplyReverseColumnsToInventoryAdjustments < ActiveRecord::Migration[8.0]
  def change
    ...
    unless column_exists?(:inventory_adjustments, :reversed_by_id)
      ...
      add_foreign_key :inventory_adjustments, :users, column: :reversed_by_id unless foreign_key_exists?(:inventory_adjustments, :users, column: :reversed_by_id)
    end
  end
end
